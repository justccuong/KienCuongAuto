...
import { FaSearch, FaPlus, FaEdit, FaTrash, FaCar, FaMapMarkerAlt, FaUser } from "react-icons/fa";
      ...
      <div className="max-w-7xl mx-auto mb-8">
        <div className="flex justify-between items-start mb-4">
          <div>
            ...
            <p className="text-gray-500 text-sm">Quản lý danh sách, thêm, sửa, xóa xe tại các chi nhánh.</p>
          </div>
